---
name: Plano desenvolvimento Boxeapp MVP
overview: Plano para iniciar o desenvolvimento do MVP do sistema de gerenciamento de academia (boxeapp), seguindo as 12 fases do PRD. O projeto já possui Next.js 16, Tailwind, Drizzle, Docker e GitHub Actions; o plano cobre desde a conclusão do setup (Drizzle, NextAuth, shadcn) até schema, CRUDs, pagamentos, agendamentos, jobs e deploy.
todos: []
isProject: false
---
